//
//  PedometerHistoricViewController.m
//  Diary
//
...
#import "PedometerHistoricViewController.h"
#import "PedometerDatePickerViewController.h"

@interface PedometerHistoricViewController ()

@end

@implementation PedometerHistoricViewController
...
- (IBAction)dateReceived:(UIStoryboardSegue *)segue {
    ...
    PedometerDatePickerViewController *controller = segue.sourceViewController;
...
- (void)showDatePickerWithType:(NSString *)dateType {
    ...
    PedometerDatePickerViewController *dateController = navController.viewControllers.lastObject;
